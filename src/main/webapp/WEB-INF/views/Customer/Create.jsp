                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" required="" id="first-name" class="form-control" name="lname" value="<%=checkInput.checkValue(request.getParameter("lname"))%>" placeholder="Last Name">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" id="first-name" required class="form-control" name="cmpname" value="<%=checkInput.checkValue(request.getParameter("cmpname"))%>" placeholder="Company name">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" id="first-name" class="form-control" name="add1" value="<%=checkInput.checkValue(request.getParameter("add1"))%>" placeholder="Address">
                                                    </div>
                                                </div>
                                                <!--                                                <div class="form-group row">
                                                                                                    <div class="col-md-4">
