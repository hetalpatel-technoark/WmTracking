...
<!--             <li  class=" <%--=uu.containsKey("Dashboard") ? "active" : ""--%> nav-item">
            ...
            <li  class=" <%--=uu.containsKey("Dashboard") ? "active" : ""--%> nav-item">
                <a href="<%=request.getContextPath()%>/customer/List"><i class="feather icon-users "></i><span class="menu-title" data-i18n="Customer">Customer</span></a>
            </li>
            ...
            <li class=" nav-item"><a href="<%=request.getContextPath()%>/driver/List" title="Driver"><i class="feather icon-user"></i><span class="menu-title" data-i18n="Email">Driver</span></a>
             ...
             <li class=" nav-item"><a href="<%=request.getContextPath()%>/job/List" title="Job"><i class="feather icon-award "></i><span class="menu-title" data-i18n="Email">Job</span></a>
            </li>
        </ul>
    </div>
</div>
